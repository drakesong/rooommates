...
const routes: Routes = [
    ...
    { path: 'chat', loadChildren: './chat/chat.module#ChatModule', data: {animation: 'Chat'}, canActivate: [AuthGuardService] },
    { path: 'explore', loadChildren: './explore/explore.module#ExploreModule', data: {animation: 'Explore'}, canActivate: [AuthGuardService] },
